...
$tauriArgs = @("npm", "run", "tauri", "--") + $Args
$commandLine = ($tauriArgs | ForEach-Object { Quote-BatchArg $_ }) -join " "
$tempScript = Join-Path $env:TEMP ("proj-eye-tauri-" + [guid]::NewGuid().ToString("N") + ".cmd")
