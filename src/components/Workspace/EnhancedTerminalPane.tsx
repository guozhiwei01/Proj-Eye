...
export default function EnhancedTerminalPane({
  ...
  useEffect(() => {
    ...
    terminal.attachCustomKeyEventHandler((event) => {
      ...
      if ((isMac ? event.metaKey : event.ctrlKey) && event.shiftKey && event.key.toLowerCase() === "v") {
          ...
          >
            ...
            >
              ...
              <span className="text-[12px] font-medium text-white/42">
                {contextMenu.selectedText ? `${modifierLabel}+Shift+C` : emptyCopyLabel}
              </span>
            </button>
            <button
              type="button"
            ...
            >
              ...
              <span className="text-[12px] font-medium text-white/42">{modifierLabel}+Shift+V</span>
            </button>
          </div>
        ) : null}
